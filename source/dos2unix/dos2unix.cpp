/*
 ******************************************************************************
 * dos2unix.cpp - Convert line breaks in a text file from DOS-style to        *
 *                UNIX-style.                                                 *
 *                                                                            *
 ...
 *                                                                            *
 * Revision History:                                                          *
 * Rev. 1.0 05-09-2005 Michael Wright - Initial release.                      *
 * Rev. 1.1 07-02-2013 Michael Wright - Bug fix for problem on Windows.       *
 * Rev. 1.2 07-07-2013 Michael Wright - Minor changes, and license file to    *
...
int main(int argc, char *argv[])
{
    ...
    if ( ! QuietMode )
        cout << "DOS to UNIX file conversion" << endl;
    ...
    for (int i=optind; i<argc; i++) {
        ...
        // current dir
        tmpOutFilename = string( tempnam(".", "d2u") );
...
void ShowUsage() {
    cout << "DOS to UNIX file conversion.\n" << endl;
    cout << "Usage: dos2unix {-q -d} filename filename ..." << endl;
    cout << "       dos2unix {-h -v}" << endl;
...
void ShowProgramInfo() {
    cout << "dos2unix " << programVersion << "  Copyright (C) 2005, 2013   Michael Wright" << endl;
